...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_camerawin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_camerawin_t qt_meta_stringdata_camerawin = {
    {
QT_MOC_LITERAL(0, 0, 9) // "camerawin"
...
QT_INIT_METAOBJECT const QMetaObject camerawin::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_camerawin.data,
    qt_meta_data_camerawin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *camerawin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_camerawin.stringdata0))
